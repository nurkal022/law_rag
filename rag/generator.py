...
- затем разделы с заголовками второго уровня, ровно такими: «## Что говорит закон», «## Как это работает на практике», «## На что обратить внимание», «## Итог». В первом — две-пять норм, относящихся к вопросу, каждая отдельным пунктом списка с полужирным названием акта и статьи, суть в одном-двух предложениях и ссылка [Источник N]; во втором — три-семь шагов нумерованным списком по одному предложению: что сделать, куда обратиться, какие сроки и документы; в третьем — до четырёх пунктов: исключения, частые ошибки, ответственность; «Итог» — одно-два предложения. Раздел, для которого нечего сказать, пропускайте; нормы «на всякий случай» и оговорки в скобках не добавляйте;
