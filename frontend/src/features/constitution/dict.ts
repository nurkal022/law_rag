...
export const dict: Dict = {
  ...
  walkHead: { ru: 'Что нашлось в каждом акте', kz: 'Әр актіде не табылды', en: 'What was found in each act' },
  walkLead: {
  ...
  replayHead: { ru: 'Как агент прошёл корпус', kz: 'Агент корпусты қалай өтті', en: 'How the agent crossed the corpus' },
  replayLead: {
